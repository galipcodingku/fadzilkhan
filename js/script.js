...
$(document).on('DOMContentLoaded', function () {
    window.ityped.init(document.querySelector('.ityped'), {
        strings: ['HALO!', 'NAMAKU IBNU FADZIL KHAN', 'KONTEN KREATOR', 'VIDEOGRAPHER', 'PHOTOGRAPHER'],
        loop: true
    });
});
...
$(document).ready(function () {
    ...
    $('.youtube').magnificPopup({
        items: {
            src: 'https://www.youtube.com/watch?v=UetIqjuHUxk&list=PLhdv91JNAmtSHur9UKexpc0pOp3jKayfk'
        },
        type: 'iframe'
    });
